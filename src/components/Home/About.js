...
const About = () => {
  return (
    <div className="text-white relative items-center text-xl w-full md:bg-gray-800 flex items-start overflow-hidden sm:flex-wrap">
      <div
        className="hidden md:visible md:absolute z-0 bg-yellow-500 absolute p-10 relative w-[50%] pb-20 z-10 flex-col justify-center h-full top-0 right-0"
        style={{
          background: `url(${Me})`,
          backgroundSize: "cover",
        }}
      ></div>
      <div className="w-full p-10 sm:p-5 flex lg:flex-row flex-col">
      <div className="">
